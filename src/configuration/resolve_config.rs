...
pub fn resolve_config(config: ConfigKeyMap, global_config: &GlobalConfiguration) -> ResolveConfigurationResult<Configuration> {
  ...
  let resolved_config = Configuration {
    ...
    expression_statement_use_parentheses: get_value(&mut config, "expressionStatement.useParentheses", ExpressionStatementParentheses::Disambiguation, &mut diagnostics),
  };
